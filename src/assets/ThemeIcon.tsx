type SVGIconProps = {
  palette: { frontColor?: string; backGroundColor?: string };
};

export function ThemeIcon(props: SVGIconProps) {
  const { frontColor, backGroundColor } = props.palette;

  return (
    <svg viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
      <rect x="65" y="59" width="49%" height="43%" fill={backGroundColor} />
      <path
        fill={frontColor}
